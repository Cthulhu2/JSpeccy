...
public class JoystickInput
        implements JoystickRawListener {

    private static final Logger LOG =
            Logger.getLogger(JoystickInput.class.getName());
    ...
    private void doTest()
        ...
        try {
            ...
            System.out.println(String.format(
                    "Joystick 1:[%s] found with %d buttons and %d axis",
            ...
            System.out.println(String.format(
                    "Joystick 2:[%s] found with %d buttons and %d axis",
        ...
        joy1.stop();
        System.out.println(String.format(
                "Joystick 1 Button events: %d, Axis events: %d",
                buttons[0], axis[0]));
        if (joy2 != null) {
            joy2.stop();
            System.out.println(String.format(
                    "Joystick 2 Button events: %d, Axis events: %d",
                    buttons[1], axis[1]));
        }
    }
    ...
    public void buttonEvent(int joystickId, int buttonId, boolean state) {
        ...
        System.out.println(String.format(
                ...
                joystickId, buttonId, state ? "pressed" : "released"));
    }
...
//        if (axisId < 16)
        System.out.println(String.format(
                "Joystick %d: Axis %d pressed. Value = [%d]",
                joystickId, axisId, value));
    }
}
