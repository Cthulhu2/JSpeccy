...
public class LoadSaveMemoryDialog
    ...
    private static final Logger LOG =
            Logger.getLogger(LoadSaveMemoryDialog.class.getName());
    ...
    public LoadSaveMemoryDialog(Memory memory) {
        ...
        binExtension = new FileNameExtensionFilter(
                bundle.getString("BINARY_EXTENSION_TYPE"), "bin");
    }
    ...
    private void loadSaveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadSaveButtonActionPerformed
        ...
        if (start + size > maxSize) {
            JOptionPane.showMessageDialog(this,
                    String.format(bundle.getString("SIZE_BINARY_ERROR"), maxSize),
                    bundle.getString("SIZE_BINARY_ERROR_TITLE"),
        ...
        if (saveDialog) {
            ...
            try (InputStream fIn = new BufferedInputStream(
                ...
                JOptionPane.showMessageDialog(this,
                        bundle.getString("LOAD_BINARY_OK"),
                        bundle.getString("LOAD_BINARY_OK_TITLE"),
                        JOptionPane.INFORMATION_MESSAGE);
            } catch (IOException ex) {
                LOG.log(Level.SEVERE, null, ex);
            }
